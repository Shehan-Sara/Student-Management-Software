...
public class StudentManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome To ABC");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Login loginFrame = new Login(); // Create an instance of the Login JFrame
    loginFrame.setVisible(true); // Set the Login JFrame to be visible
    dispose();
